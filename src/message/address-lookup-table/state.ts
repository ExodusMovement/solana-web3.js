...
export class AddressLookupTableAccount {
  ...
  static deserialize(accountData: Uint8Array): AddressLookupTableState {
    const meta = <typeof LookupTableMetaLayout.layout>decodeData(LookupTableMetaLayout, accountData);
    ...
    const {addresses} = <{addresses: Array<Uint8Array>}><unknown>BufferLayout.struct([
